...
二、关于本服务
2.1本服务内容
本服务内容是指凯达来向用户提供的跨平台的生活助手（“小蜜蜂智慧生活”APP软件），同时提供由物业提供的基础服务、增值物业服务，周边商圈优惠信息，在线支付，政府提供的公共资源等服务内容。
2.2本服务形式
2.2.1 您使用本服务需要下载小蜜蜂智慧生活软件，对于这些软件，凯达来给予您一项个人的、不可转让及非排他性的许可。
2.2.2 本服务中小蜜蜂智慧生活软件提供包括但不限于iOS、android等多个应用版本，用户必须选择与所安装手机相匹配的软件版本。
2.3许可的范围
...
七、主权利义务条款
7.1 账号使用规范
7.1.1 您在使用本服务前需要注册一个唯一的小蜜蜂账号。注册账号时请按照软件的提示进行注册，为使填写的信息能尽快被核实通过，请填写您真实的个人及住址信息。 7.1.2 小蜜蜂账号的所有权归凯达来所有，用户完成申请注册手续后，仅获得小蜜蜂账号的使用权，且该使用权仅属于初始申请注册人，同时，初始申请注册人不得赠与、借用、租用、转让或售卖小蜜蜂账号或者以其他方式许可非初始申请注册人使用小蜜蜂账号。非初始申请注册人不得通过受赠、继承、承租、受让或者其他任何方式使用小蜜蜂账号。 7.1.3 用户有责任妥善保管注册账户信息及账户密码的安全，用户需要对注册账户以及密码下的行为承担法律责任。用户同意在任何情况下不向他人透露账户及密码信息。在您怀疑他人在使用您的账号时，您应立即通知凯达来公司。
7.2 用户注意事项
...
7.2.3.5 由于无线网络信号不稳定、无线网络带宽小等原因，所引起的小蜜蜂登录失败、资料同步不完整、页面打开速度慢等风险。
...
八、用户行为规范
8.1 信息内容规范
8.1.1 您理解并同意，凯达来一直致力于为用户提供文明健康、规范有序的网络环境，您不得利用小蜜蜂账号或许可软件及服务制作、复制、发布、传播如下干扰许可软件正常运营，以及侵犯其他用户或第三方合法权益的内容，包括但不限于：
...
8.2.4 对许可软件或者许可软件运行过程中释放到任何终端内存中的数据、软件运行过程中与服务器端的交互数据，以及许可软件运行所必需的系统数据，进行复制、修改、增加、删除、挂接运行或创作任何衍生作品，形式包括但不限于使用插件、外挂或非凯达来经授权的第三方工具/服务接入许可软件和相关系统；
8.2.5 通过修改或伪造软件运行中的指令、数据，增加、删减、变动软件的功能或运行效果，或者将用于上述用途的软件、方法进行运营或向公众传播，无论这些行为是否为商业目的；
8.2.6 通过非凯达来开发、授权的第三方软件、插件、外挂、系统，登录或使用小蜜蜂智慧生活软件及服务，或制作、发布、传播上述工具；
...
8.3.5 未经凯达来书面许可利用小蜜蜂账号和任何功能，以及第三方运营平台进行推广或互相推广的；
8.3.6 利用小蜜蜂账号或许可软件及服务从事任何违法犯罪活动的；
...
十、终端安全责任
10.1 您理解并同意，许可软件同大多数互联网软件一样，可能会受多种因素影响，包括但不限于用户原因、网络服务质量、社会环境等；也可能会受各种安全问题的侵扰，包括但不限于他人非法利用用户资料，进行现实中的骚扰；用户下载安装的其他软件或访问的其他网站中可能含有病毒、木马程序或其他恶意程序，威胁您的终端设备信息和数据安全，继而影响许可软件的正常使用等。因此，您应加强信息安全及个人信息的保护意识，注意密码保护，以免遭受损失。 10.2 您不得制作、发布、使用、传播用于窃取小蜜蜂账号及他人个人信息、财产的恶意程序。 10.3 维护软件安全与正常使用是凯达来和您的共同责任，凯达来将按照行业标准合理审慎地采取必要技术措施保护您的终端设备信息和数据安全，但是您承认和同意凯达来并不能就此提供完全保证。 10.4 在任何情况下，您不应轻信借款、索要密码或其他涉及财产的网络信息。涉及财产操作的，请一定先核实对方身份，并请经常留意凯达来有关防范诈骗犯罪的提示。 10.5 若其他用户发布有攻击性的内容时，您可以通过提交举报或屏蔽的方式进行设置。也可在设置中取消对其用户的屏蔽。
十一、第三方软件或技术
...
十二、账号注销
12.1您可以通过以下方式注销您的账号： 登入小蜜蜂智慧生活APP，通过“我的-设置-账号管理-注销账号”来注销账号。在您注销账号前，请确保你在小蜜蜂智慧生活APP的账号同时满足以下条件，否则你注销账号的申请可能会被拒绝： （1）账户在小蜜蜂智慧生活APP中无资产、无欠款； （2）账户内无未完成的订单、已提供服务单未支付的订单/服务； 在您主动注销账户之后，我们将停止为您提供产品或服务，我们将删除您的个人信息，使其保持不可被检索、访问的状态，或对使其进行匿名化处理。 12.2若想要删除部分您所填写的信息，如实名认证中（身份证号、身份证图像），请通过0574-87760023与我们联系。
隐私政策
...
1.个人信息的收集 2.个人信息的使用 3.个人信息的披露 4.个人信息的共享 5.安全 6.第三方网站 7.未成年人保护 8.联系我们
1.个人信息的收集 
1.1信息收集目的 
根据国家APP实名制管理规定，我们保存、使用和披露个人信息是为了通过创建账户、识别用户、回应查询等方式来为您提供服务。在得到您的许可之后，“小蜜蜂智慧生活APP”会向您提供基础物业服务、便民生活服务、业主自治及社交服务、社区生活相关的服务、发送资讯、调查、优惠和促销信息以及其他宣传材料，以为您提供更好的服务。物业基础服务包括：报修报事、生活缴费、蓝牙开门、访客通行、鹰眼服务、投诉表扬、常用电话、快递服务、装修管家、活动投票、问卷调查、咨询建议、资讯服务、幸福里、快递代寄、车位库房等服务。 

1.2 信息收集的主要范围及方式 
为实现“小蜜蜂智慧生活APP”之服务目的，“小蜜蜂智慧生活APP”会通过技术手段收集您的个人信息，通过技术手段所收集的个人信息仅限于您的姓名、出生日期、身份证号码、联系方式、住址等使用“小蜜蜂智慧生活APP”所必需的信息。此外，为确保园区安全，使用蓝牙开门及鹰眼服务，需根据审核规范，上传您的有效身份证信息。 “小蜜蜂智慧生活APP”支持多类操作系统的使用：在您通过各种手机操作系统使用“小蜜蜂智慧生活APP”的过程中，“小蜜蜂智慧生活APP”所收集的信息仅限于您同意使用“小蜜蜂智慧生活APP”基本服务所必需的信息。 我们会遵循正当、合法、必要的原则，出于本政策所述的目的收集和使用您的个人信息。您需要授权我们收集和使用个人信息的场景如下所示： 
例：服务项——目的及收集范围 
...
共享停车——如您使用共享停车功能时，我们可能会收集您的姓名、联系方式、车牌号、使用次数、使用时间、车位信息。 
...
中信ETC——如您使用中信ETC功能时，我们会收集您的姓名、联系方式、车牌号、交易和消费信息、订单信息、虚拟财产信息。 
...
园区健康——如您使用生活健康功能时，我们可能会收集您的姓名、联系方式、园区信息、房号、使用时间信息。 
服务者评价——如您使用服务者评价功能时，我们会收集您所上传或下载的信息，这类信息包括搜索关键字、发布和回复信息。
开门码——如您使用开门码功能时,我们会收集您的姓名、联系方式、住址信息。
您需要授权访问及使用权限的功能场景如下所示： 
业务场景——访问及使用权限、实名认证、需要扫码证件或者选择相册图片、使用相机设备权限、访问外部存储权、写外部存储权限。 
社区——需要拍照或选择相册图片、使用相机设备权限、访问外部存储权限、写外部存储权限 。
更换头像 更换头像需要拍照或选择相册图片 使用相机设备权限、访问外部存储权限、写外部存储权限 。
活动添加参与人——参与人头像可以编辑，需要拍照或选择相册图片 使用相机设备权限、访问外部存储权限、写外部存储权限 。
首页扫一扫——需要调用设备摄像头二维码或者从相册里选择图片 使用相机设备权限、访问外部存储权限、写外部存储权限 
订单评价——订单评价可以添加图片，需要拍照或选择相册图片、使用相机设备权限、访问外部存储权限、写外部存储权限 
报事报修——可以添加图片、使用相机设备权限、访问外部存储权限、写外部存储权限。
商家和商品详情页——拨打商家和客服电话，需要拨打电话权限。 
电话物业——物业管家首页，点击“物业电话”，需要拨打电话权限。
常用电话——拨打电话权限。
语音管家——语音报事，需要语音识别 访问录音权限
保存图片、查看图片——点击保存图片，访问外部存储权限、写外部存储权限 。
任务发布——填写目标地址时，需要定位权限、访问位置权限、手机麦克风、听筒访问权限、语音识别、访问录音权限。
蓝牙开门——蓝牙开门需要定位当前蓝牙点位置 访问位置权限
1.3 信息推送及服务 
您提供的信息，“小蜜蜂智慧生活APP”将最大限度尽合理之商业义务进行保密。经过您的同意，“小蜜蜂智慧生活APP”将会向您提供电子商务、生活服务、资讯、版本升级等服务。 为确保您的服务体验，在您使用平台功能时，根据服务状态，将为您发送快递、物业缴费、访客、物业工单、巡查、物品借用、活动报名、红包、拼团、商品订单、售后工单、发票状态信息，以及对快递服务的短信通知服务。
1.4 收集信息的其他方式 
我们将采用其他方式（例如：信息下载、购买产品或服务、用户支持、反馈以及调查表）来收集您的个人信息。如果您将个人信息填写在其他开放的平台上，其他用户可能会获知您的信息。
1.5 收集的其他信息 
为了便于您使用“小蜜蜂智慧生活APP”软件，我们的服务器将会收集关于您的移动通讯设备的信息，例如型号、设备ID、互联网协议地址、您访问的时间和地点、路由数据包、信息发送人和接收数据（但不是信息本身），以及其他类似的特征记录。
2.个人信息的使用 
2.1 您的个人信息将不会用于本政策载明的目的之外的其他目的，双方另有约定的除外。 2.2 匿名汇总统计数据不是“小蜜蜂智慧生活APP”所定义的个人用户信息，我们将为多种目的，包括但不限于分析和使用模式的报告等，来保存和使用此类信息。用户使用本APP的，视为已授权“小蜜蜂智慧生活APP”提供方以任何目的自身或许可第三方使用和披露匿名汇总统计数据的权利。
3.个人信息的披露 
...
4.个人信息的共享 
您于此授权，我们将在必要时，向合作的第三方提供您的个人信息，以便为您提供某些服务或代表我们履行职能，我们仅会处于本隐私条款声明的合法、正当、必要、特定、明确的目的共享您的信息，合作的第三方只能接触到其履行职责所需信息，且不得将此信息用于其他任何目的，我们不允许合作的第三方伴进行转委托。
关于合作的第三方的信息及提供的服务、场景应用见下：
第三方名称：深圳市凯达来科技有限公司
场景描述：app数据统计
个人信息类型：个人常用设备信息
个人信息字段：设备信息、网络信息
5.安全 
对我们来说，个人信息的安全非常重要。我们将尽可能保障您的个人信息安全，并实施合理的措施限制非授权访问、使用或者披露您的个人信息。尽管采取上述措施，但是您应当知晓“小蜜蜂智慧生活APP”不能完全避免与个人信息相关的安全危险。 双方同意，如发生下述情形，“小蜜蜂智慧生活”APP不承担任何法律责任： 
①依据法律规定或相关政府部门的要求提供您的个人信息；
②由于您的使用不当而导致任何个人信息的泄露；
③任何由于黑客攻击，电脑病毒的侵入，非法内容信息、骚扰信息的屏蔽，政府管制以及其他任何网络、技术、通信线路、信息安全管理措施等非“小蜜蜂智慧生活”APP原因造成的服务中断、受阻等不能满足用户要求的情形； 您应当协助我们以保护您的个人信息安全。例如，不要泄露您的个人密码。
6.第三方网站 
6.1 当您点击“小蜜蜂智慧生活APP”链接的其他网站时，您已经离开我们的网站并访问其他网站，其他网站可能会收集您的个人信息或匿名数据，因此，我们无法控制、检查或者回应此类网站和网站内容。
6.2 本政策不适用于在您点击链接后的外部网站收集数据的行为。
7.未成年人保护 
“小蜜蜂智慧生活APP”非常重视对未成年人信息的保护。根据相关法律法规的规定，若您是18周岁以下的未成年人，在使用本APP服务前，应事先取得您家长或法定监护人的书面同意。“小蜜蜂智慧生活APP”不会使用未成年人的个人信息，也不会向任何第三方透露可识别的信息。若您是未成年人的监护人，当您对您所监护的未成年人的个人信息有相关疑问时，请通过第8节中的联系方式与我们联系。
8.联系我们 
当您有其他的投诉、建议、未成年人个人信息相关问题时，您可以将您的问题发送至kaidalai@163.com 。我们将尽快审核所涉问题，并在验证您的用户身份后的十五天内予以回复。
