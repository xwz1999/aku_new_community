...
2.2本服务形式
2.2.1 您使用本服务需要下载小蜜蜂软件，对于这些软件，凯达来给予您一项个人的、不可转让及非排他性的许可。
2.2.2 本服务中小蜜蜂软件提供包括但不限于iOS、android等多个应用版本，用户必须选择与所安装手机相匹配的软件版本。
2.3许可的范围
...
8.2.6 通过非凯达来开发、授权的第三方软件、插件、外挂、系统，登录或使用小蜜蜂软件及服务，或制作、发布、传播上述工具；
...
十二、账号注销
12.1您可以通过以下方式注销您的账号： 登入小蜜蜂APP，通过“我的-设置-账号管理-注销账号”来注销账号。在您注销账号前，请确保你在小蜜蜂APP的账号同时满足以下条件，否则你注销账号的申请可能会被拒绝： （1）账户在小蜜蜂APP中无资产、无欠款； （2）账户内无未完成的订单、已提供服务单未支付的订单/服务； 在您主动注销账户之后，我们将停止为您提供产品或服务，我们将删除您的个人信息，使其保持不可被检索、访问的状态，或对使其进行匿名化处理。 12.2若想要删除部分您所填写的信息，如实名认证中（身份证号、身份证图像），请通过0574-87760023与我们联系。
隐私政策
...
1.个人信息的收集 
1.1信息收集目的 
根据国家APP实名制管理规定，我们保存、使用和披露个人信息是为了通过创建账户、识别用户、回应查询等方式来为您提供服务。在得到您的许可之后，“小蜜蜂APP”会向您提供基础物业服务、便民生活服务、业主自治及社交服务、社区生活相关的服务、发送资讯、调查、优惠和促销信息以及其他宣传材料，以为您提供更好的服务。物业基础服务包括：报修报事、生活缴费、蓝牙开门、访客通行、鹰眼服务、投诉表扬、常用电话、快递服务、装修管家、活动投票、问卷调查、咨询建议、资讯服务、幸福里、快递代寄、车位库房等服务。 

1.2 信息收集的主要范围及方式 
为实现“小蜜蜂APP”之服务目的，“小蜜蜂APP”会通过技术手段收集您的个人信息，通过技术手段所收集的个人信息仅限于您的姓名、出生日期、身份证号码、联系方式、住址等使用“小蜜蜂APP”所必需的信息。此外，为确保园区安全，使用蓝牙开门及鹰眼服务，需根据审核规范，上传您的有效身份证信息。 “小蜜蜂APP”支持多类操作系统的使用：在您通过各种手机操作系统使用“小蜜蜂APP”的过程中，“小蜜蜂APP”所收集的信息仅限于您同意使用“小蜜蜂APP”基本服务所必需的信息。 我们会遵循正当、合法、必要的原则，出于本政策所述的目的收集和使用您的个人信息。您需要授权我们收集和使用个人信息的场景如下所示： 
例：服务项——目的及收集范围 
...
1.3 信息推送及服务 
您提供的信息，“小蜜蜂APP”将最大限度尽合理之商业义务进行保密。经过您的同意，“小蜜蜂APP”将会向您提供电子商务、生活服务、资讯、版本升级等服务。 为确保您的服务体验，在您使用平台功能时，根据服务状态，将为您发送快递、物业缴费、访客、物业工单、巡查、物品借用、活动报名、红包、拼团、商品订单、售后工单、发票状态信息，以及对快递服务的短信通知服务。
1.4 收集信息的其他方式 
我们将采用其他方式（例如：信息下载、购买产品或服务、用户支持、反馈以及调查表）来收集您的个人信息。如果您将个人信息填写在其他开放的平台上，其他用户可能会获知您的信息。
1.5 收集的其他信息 
为了便于您使用“小蜜蜂APP”软件，我们的服务器将会收集关于您的移动通讯设备的信息，例如型号、设备ID、互联网协议地址、您访问的时间和地点、路由数据包、信息发送人和接收数据（但不是信息本身），以及其他类似的特征记录。
2.个人信息的使用 
2.1 您的个人信息将不会用于本政策载明的目的之外的其他目的，双方另有约定的除外。 2.2 匿名汇总统计数据不是“小蜜蜂APP”所定义的个人用户信息，我们将为多种目的，包括但不限于分析和使用模式的报告等，来保存和使用此类信息。用户使用本APP的，视为已授权“小蜜蜂APP”提供方以任何目的自身或许可第三方使用和披露匿名汇总统计数据的权利。
3.个人信息的披露 
...
个人信息字段：设备信息、网络信息
5.安全 
对我们来说，个人信息的安全非常重要。我们将尽可能保障您的个人信息安全，并实施合理的措施限制非授权访问、使用或者披露您的个人信息。尽管采取上述措施，但是您应当知晓“小蜜蜂APP”不能完全避免与个人信息相关的安全危险。 双方同意，如发生下述情形，“小蜜蜂生活”APP不承担任何法律责任： 
①依据法律规定或相关政府部门的要求提供您的个人信息；
②由于您的使用不当而导致任何个人信息的泄露；
③任何由于黑客攻击，电脑病毒的侵入，非法内容信息、骚扰信息的屏蔽，政府管制以及其他任何网络、技术、通信线路、信息安全管理措施等非“小蜜蜂生活”APP原因造成的服务中断、受阻等不能满足用户要求的情形； 您应当协助我们以保护您的个人信息安全。例如，不要泄露您的个人密码。
6.第三方网站 
6.1 当您点击“小蜜蜂APP”链接的其他网站时，您已经离开我们的网站并访问其他网站，其他网站可能会收集您的个人信息或匿名数据，因此，我们无法控制、检查或者回应此类网站和网站内容。
6.2 本政策不适用于在您点击链接后的外部网站收集数据的行为。
7.未成年人保护 
“小蜜蜂APP”非常重视对未成年人信息的保护。根据相关法律法规的规定，若您是18周岁以下的未成年人，在使用本APP服务前，应事先取得您家长或法定监护人的书面同意。“小蜜蜂APP”不会使用未成年人的个人信息，也不会向任何第三方透露可识别的信息。若您是未成年人的监护人，当您对您所监护的未成年人的个人信息有相关疑问时，请通过第8节中的联系方式与我们联系。
8.联系我们 
