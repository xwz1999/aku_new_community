      ...
      body: Center(
        child: Column(
          children: [
            ...
            48.w.heightBox,
            '正在审核中'.text.color(ktextPrimary).size(36.sp).bold.make(),
            16.w.heightBox,
            '使用后请记得归还'.text.color(ktextSubColor).size(26.sp).make(),
            95.w.heightBox,
            MaterialButton(
              color: kPrimaryColor,
              ...
              child: '返回物品借还列表'.text.color(ktextPrimary).size(36.sp).make(),
            )
          ],
        ),
      ).pSymmetric(
